<?php
/**
 * Master Lobby Display (Papan Informasi Jadwal Ruang Rapat - Lobby Utama)
 * URL: display_lobby.php
 */
...
// Filter HANYA booking confirmed yang MASIH BERLANGSUNG atau AKAN DATANG (Selesai otomatis hilang)
